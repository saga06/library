...
/**
 * Interceptor permettant de vérifier qu'utilisateur est bien connecté et existe en session.
...
public class AuthInterceptor extends AbstractInterceptor {
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
        ...
        if (invocation.getInvocationContext().getSession().get("user") != null) {
            ...
            // si je n'ai pas d'utilisateur en session, on retourne un result (error-forbidden)
        } else {
